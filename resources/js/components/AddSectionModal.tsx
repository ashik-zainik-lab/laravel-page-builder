...
export default function AddSectionModal() {
    ...
    useEffect(() => {
        ...
        if (
            !selectedType ||
            !filteredEntries.some((entry) => entry.type === selectedType)
        ) {
        ...
        >
            {isMobile && (
                <div className="px-3 py-3 border-b flex items-center justify-between bg-white shrink-0">
                    ...
                    <button
                        onClick={() =>
                            previewEntry && handleAddEntry(previewEntry)
                        }
            ...
            <div className="flex-1 overflow-hidden relative p-2 flex items-center justify-center">
                ...
                {previewError && !isPreviewLoading && (
                    <div className="absolute top-2 left-2 right-2 z-10 bg-amber-50 px-2.5 py-1.5 text-xs text-amber-700 text-center">
                        {previewError}
                    </div>
                )}
